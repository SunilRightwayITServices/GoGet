...
import com.au.rightway.weatherforecast.di.modules.SupportModules_ProvideGsonFactory;
import com.au.rightway.weatherforecast.di.modules.SupportModules_ProvideOkHttpCacheFactory;
import com.au.rightway.weatherforecast.di.modules.SupportModules_ProvideOkHttpClientFactory;
import com.au.rightway.weatherforecast.di.modules.SupportModules_ProvideRetrofitFactory;
import com.au.rightway.weatherforecast.di.modules.SupportModules_ProvideSchedulerProviderFactory;
import com.au.rightway.weatherforecast.di.modules.SupportModules_ProvidesApplicationFactory;
import com.au.rightway.weatherforecast.di.modules.SupportModules_ProvideweatherforecastAPIFactory;
...
public final class DaggerSupportComponents implements SupportComponents {
  ...
  private Provider<weatherforecastApplication> providesApplicationProvider;
  ...
  private Provider<WeatherForecastApi> provideweatherforecastAPIProvider;
  ...
  private void initialize(final Builder builder) {
    ...
    this.provideweatherforecastAPIProvider =
        DoubleCheck.provider(
            SupportModules_ProvideweatherforecastAPIFactory.create(
  ...
  @Override
  public WeatherForecastApi getWeatherforecastApi() {
    return provideweatherforecastAPIProvider.get();
  }
